 ...
 * genuinely painful). Mirrors web/src/components/SearchableSelect.tsx —
 * duplicated rather than shared, same as every other cross-app convention
 * in this monorepo (the two frontends don't share UI components).
 */
export function SearchableSelect({ value, onChange, options, placeholder, noResultsText, disabled }: Props) {
